...
public partial class arimeticaLexer : Lexer {
	...
	public arimeticaLexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public arimeticaLexer(ICharStream input, TextWriter output, TextWriter errorOutput)
